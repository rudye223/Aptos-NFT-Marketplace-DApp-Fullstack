...
module NFTMarketplace {
 ...
 // Initialize resource for chat
    ...
    #[view]
    public fun is_user_initialized_own_chat(user_address: address): bool {
        exists<Chats>(user_address)
    }
...
public entry fun create_chat(account: &signer, recipient: address) acquires Chats {
 ...
 // Lazily initialize Chats resource for sender if it doesn't exist
    if (!exists<Chats>(sender)) {
        initialize_chat(account); 
    };
